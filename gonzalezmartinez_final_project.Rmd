...
Then, I created a graph that would allow highlights, which required some changes to the graph structure previously used. In this graph
...
#make anew object to customise the inetractive plot
gg <- ggplotly(gr_int4, 
...
I like this graph because by default it shows the national trend and people can then make comparisons between regions by playing with the singe and double click features in the legend. **You should give it a try!**
...
* From May 2016 to March 2020, the national rate was consistently above the benchmark rate (66.7%). London, the North East, the North West, the East Midlands, and Yorkshire and the Humber were consistently above the national rate and benchmark rates. The East of England, the South East, the South West, and the West Midlands were consistently below the benchmark and national rate 
